...
import { View, Button, Text, TextInput, ActivityIndicator, StyleSheet, AsyncStorage } from 'react-native';
...
export default class Login extends React.Component {
  ...
  onSubmit() {
    ...
    return(
      fetch(`http://localhost/api/login.json?id=${this.state.name}&password=${this.state.password}`)
